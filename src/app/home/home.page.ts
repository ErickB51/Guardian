    ...
    constructor(private storage: Storage, private accountService: AccountService, private toastController: ToastController) {
       ...
       this.storage.get('firstTime').then(result=>{
           if(!result){
               ...
               this.storage.set('conquistas',[{titulo: 'Novato', tipo: 1, progresso: 0.0, tarefas: 1},{titulo: 'Aprendiz', tipo: 1, progresso: 0.0, tarefas: 7},{titulo: 'Guerreiro', tipo: 1, progresso: 0.0, tarefas: 15},{titulo: 'Persistente', tipo: 1, progresso: 0.0, tarefas: 30},{titulo: 'Audacioso', tipo: 1, progresso: 0.0, tarefas: 90},{titulo: 'Praticamente uma Maquina', tipo: 1, progresso: 0.0, tarefas: 365},
                                             {titulo: 'Chique', tipo: 2, progresso: 0.0, tarefas: 1},{titulo: 'Refinado', tipo: 2,progresso: 0.0, tarefas: 5},{titulo: 'Aspirante da Moda', tipo: 2, progresso: 0.0, tarefas: 10},{titulo: 'Chavoso', tipo: 2, progresso: 0.0, tarefas: 15},{titulo: 'Estilo Unico', tipo: 2, progresso: 0.0, tarefas: 20},{titulo: 'Burgues', tipo: 2, progresso: 0.0, tarefas: 25}, 
               ...
               this.storage.set('visuais',[{nome: 'Amarelao', equipado: true, href: 'https://i.ibb.co/0jVsxPC/robo-1.png'},{nome: 'Verdao', equipado: true, href: 'https://i.ibb.co/DgmN4J6/robo-2.png'},{nome: 'Cinzao', equipado: true, href: 'https://i.ibb.co/7GBMPgX/robo-3.png'},{nome: 'Vermelhao', equipado: true, href: 'https://i.ibb.co/WnjYvS9/robo-4.png'}]);
